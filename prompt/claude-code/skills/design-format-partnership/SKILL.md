...
description: >
  ...
  参考: plural-reality-design-system/examples/plural-reality-partnership-style.html
...
## 参考ファイル
- テンプレート (HTML): `plural-reality-design-system/examples/plural-reality-partnership-style.html`
