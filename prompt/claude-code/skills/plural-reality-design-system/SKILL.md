...
| 名称 | Hex | RGB | 用途 |
|---|---|---|---|
| **Brand Teal** | `#0D9488` | 13, 148, 136 | CTA、リンク、ハイライト、ブランド要素 |
...
- **印刷時**: Brand Teal は CMYK `C:91 M:0 Y:40 K:35` で指定（Pantone 7718 C 相当）
...
- **見出しは軽く**: ウェイト 400（Regular）で十分。太字にしない
...
```
  背景: linear-gradient(to right, #111111, #0D9488, #111111)
...
- **英語**: sentence case（先頭のみ大文字）を好む
- **日本語**: 簡潔な体言止め or 常体
- **数値**: 具体的に。"significant growth" ではなく "47% YoY growth"
...
- **マージン**: 上下左右 60px 以上
- **アクセントライン**: Brand Teal `#0D9488` で控えめに
